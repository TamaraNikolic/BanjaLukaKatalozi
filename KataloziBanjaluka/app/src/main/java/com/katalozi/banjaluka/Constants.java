...
public class Constants {
    ...
    public static final String FACEBOOK = "https://www.facebook.com/tamara.nikolic.524";
    public static final String EMAIL = "katalozi@banjaluka.com";
    public static final String PHONE = "051 962 405";
    public static final String GOOGLE_PLAY = "https://play.google.com/store/apps/details?id=com.peter.tewntydayswith1peter&hl=en";
